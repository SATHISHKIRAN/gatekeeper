...
const PrincipalReports = () => {
    ...
    const fetchMetadata = async () => {
        try {
            // Reusing admin endpoints for metadata as Principal is also high-level
    ...
    const fetchReports = async () => {
        ...
        try {
            ...
            const response = await axios.get(`/api/principal/reports?${queryParams.toString()}`, {
        ...
        <div className="space-y-6 p-6 max-w-[1600px] mx-auto pb-24">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 print:hidden">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">Generate reports for the entire campus.</p>
                </div>
                                        ...
                                        <div className="flex items-center justify-between mb-4 w-full">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="text-left">
                                                    <h1 className="text-xl font-black uppercase leading-none mb-1">{settings?.app_name || 'Campus Report'}</h1>
                                                    <p className="text-[10px] uppercase font-bold text-slate-600 px-0.5">Principal Oversight Registry</p>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <div className="text-lg font-black uppercase">Institutional Log</div>
                                ...
                                <tr className="print-footer-row">
                                    <td>
                                        <div className="mt-8 flex justify-between items-end">
                                            <div className="text-center border-t border-black pt-2 w-48 text-[10px] font-bold">PRINCIPAL SIGNATURE</div>
                                            <div className="text-[8px] font-mono text-slate-500 uppercase">
                                                CONFIDENTIAL REPORT • GENERATED BY {settings?.app_name || 'SYSTEM'}
                                            </div>
                                            <div className="text-center border-t border-black pt-2 w-48 text-[10px] font-bold">INSTITUTION SEAL</div>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
