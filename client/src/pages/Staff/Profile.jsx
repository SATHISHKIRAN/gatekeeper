...
import { User, Shield, Key, Bell, Building, CheckCircle, Users, Activity, Mail, Phone, Calendar } from 'lucide-react';
                ...
                >
                    <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 dark:border-slate-800 p-8 text-center relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="w-32 h-32 mx-auto bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-slate-800 dark:to-slate-800 rounded-full flex items-center justify-center text-4xl font-bold text-blue-600 dark:text-blue-400 mb-6 shadow-inner ring-4 ring-white dark:ring-slate-800">
                            ...
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 rounded-full text-xs font-bold uppercase tracking-wide border border-emerald-100 dark:border-emerald-800">
                                <Activity className="w-3 h-3" /> {stats.status}
                            </div>
                        </div>
                        ...
                        <div className="mt-8 grid grid-cols-2 gap-4 border-t border-slate-100 dark:border-slate-800 pt-6">
                            <div className="text-center">
                                <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.mentees_count}</p>
                                <p className="text-xs text-slate-400 uppercase tracking-wider font-semibold">Mentees</p>
                            </div>
                            <div className="text-center">
                                <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.approvals_given}</p>
                                <p className="text-xs text-slate-400 uppercase tracking-wider font-semibold">Approvals</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 dark:border-slate-800 p-8">
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6 flex items-center gap-2">
                            <Building className="w-5 h-5 text-blue-500" /> Professional Details
                        </h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-1">
                                ...
                                <p className="font-medium text-slate-900 dark:text-white truncate" title={userData.email}>{userData.email}</p>
                            </div>
                            <div className="space-y-1">
                                <label className="text-xs font-bold text-slate-400 uppercase tracking-wide flex items-center gap-2">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="font-medium text-slate-900 dark:text-white">{userData.department_name || 'N/A'}</p>
                            </div>
                            <div className="space-y-1">
                                <label className="text-xs font-bold text-slate-400 uppercase tracking-wide flex items-center gap-2">
                    ...
                    <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 dark:border-slate-800 p-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                                ...
                                <button className="px-5 py-2 bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 border border-purple-100 dark:border-purple-800 rounded-xl text-xs font-bold hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors">
                                    Enable
                                </button>
                            </div>
                        </div>
